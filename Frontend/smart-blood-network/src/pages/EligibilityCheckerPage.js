...
import "./EligibilityCheckerPage.css"; // Make sure to add this image
...
function EligibilityCheckerPage() {
  ...
  return (
    <div className="ec-bg-container">
      <div className="ec-overlay"></div>
      <div className="ec-content">
        <button onClick={goBack} className="ec-back-button">
          <FaArrowLeft /> Back
        </button>
